...
type: "AI / Travel"
description: "A day-by-day trip planner built around Muslim travel needs — halal food, prayer times, and walkable routes, all in one place."
order: 1
...
Everything runs client-side — no backend, no account, no server. The user supplies their own Gemini API key in the browser.
...
- Export itinerary to PDF or Google Calendar
